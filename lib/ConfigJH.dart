...
const Color SSU_BLUE = Colors.blue;
const Color SSU_BLACK = Colors.black;
const Color SSU_GRAY = Color.fromARGB(255, 218, 221, 223);
const Color SSU_WEAKGRAY = Color.fromARGB(255, 251, 251, 251);
